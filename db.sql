...
CREATE TABLE IF NOT EXISTS `lc_user1` (
  ...
  `i_isCredentialNonExpired` tinyint(4) DEFAULT NULL,
  `u_isEnabled` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`u_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- 테이블 데이터 jung.lc_user1:~0 rows (대략적) 내보내기
...
INSERT INTO `spring_session` (`PRIMARY_ID`, `SESSION_ID`, `CREATION_TIME`, `LAST_ACCESS_TIME`, `MAX_INACTIVE_INTERVAL`, `EXPIRY_TIME`, `PRINCIPAL_NAME`) VALUES
	('5f8af127-c044-42ba-be91-64921ed6a0a2', 'd5d9dadc-decc-4e38-b5c8-2b367e46e760', 1638542907127, 1638542909556, 7200, 1638550109556, NULL);
